...
static Key keys[] = {
	...
	{ MODKEY|ALTKEY,                XK_p,      spawn,          {.v = dmenucmd } },
...
static Button buttons[] = {
	...
	{ ClkStatusText,           0,              Button5,        spawn,          SHCMD("~/.config/sxhkd/sound.sh -") },
	{ ClkStatusText,           0,              Button4,        spawn,          SHCMD("~/.config/sxhkd/sound.sh +") },
	{ ClkStatusText,           ShiftMask,      Button5,        spawn,          SHCMD("~/.config/sxhkd/brightness.sh -") },
	{ ClkStatusText,           ShiftMask,      Button4,        spawn,          SHCMD("~/.config/sxhkd/brightness.sh +") },
